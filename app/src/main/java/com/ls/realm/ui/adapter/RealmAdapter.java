...
public class RealmAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private OnActionClickListner mActionClickListner;
    ...
    public void setOnActionClickListner(OnActionClickListner listner)
    {
        mActionClickListner=listner;
    }
    ...
    private void initUser(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        final User user = (User) mDataList.get(position);
        ...
        if(user.isValid()) {
            ...
            viewHolder.ivDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (mActionClickListner != null)
                        mActionClickListner.onDeleteUser(user);
                }
            });
        }else
        {
            viewHolder.txtFirstName.setText("Remove");
            viewHolder.txtLastName.setText("remove");
    ...
    private static class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public UserViewHolder(View v) {
            ...
            ivDelete= (ImageView) v.findViewById(R.id.ivDeleteUser);
        }
    }
